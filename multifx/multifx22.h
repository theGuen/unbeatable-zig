...
void instanceResetUserInterfacemydsp(mydsp* dsp) {
	...
	dsp->fEntry15 = (FAUSTFLOAT)20000.0f;
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	...
	ui_interface->addNumEntry(ui_interface->uiInterface, "hp_freq", &dsp->fEntry15, (FAUSTFLOAT)20000.0f, (FAUSTFLOAT)100.0f, (FAUSTFLOAT)20000.0f, (FAUSTFLOAT)100.0f);
